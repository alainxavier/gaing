<?php
  ...
  switch ($annees) {
    case "2021-2022":
      $query = "SELECT acteurs.id_acteur, nom, prenoms FROM acteurs LEFT JOIN activites_2122 ON acteurs.id_acteur=activites_2122.id_acteur WHERE annees IS NULL ORDER BY nom, prenoms";
      break;
    default:
      $query = "SELECT acteurs.id_acteur, nom, prenoms FROM acteurs LEFT JOIN activites_2021 ON acteurs.id_acteur=activites_2021.id_acteur WHERE annees IS NULL ORDER BY nom, prenoms";
    }
